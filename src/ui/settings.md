...
### `SettingsPanel`
- **Does**: Holds the editable `AgentConfig`, visibility state, selected tab, discovered plugin manifests, and embedded skill-specific subpanels.
- **Interacts with**: `AgentConfig`, `api::BackendPluginManifest`, `comfy_settings.rs`, `orbweaver_settings.rs`
...
### Core tab renderers
- **Does**: Render grouped core settings tabs: `General`, `Behavior`, `Living Loop`, `Memory`, and `System`.
